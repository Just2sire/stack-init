    ...
    models: [
      ...
      },
      {
        ...
        fields: [
          ...
          { name: 'last_activity', type: 'integer',   nullable: false },
        ],
        relations: [
          { type: 'belongsTo', model: 'User' },
        ],
        generate: { ...DEFAULT_GENERATE, controller: false, routes: false, factory: false },
      ...
      },
      {
        ...
        relations: [],
        generate: { ...DEFAULT_GENERATE, controller: false, routes: false, factory: false },
        migration: { primary_key: 'email', timestamps: false, softDeletes: false },
      },
    ],
  },
